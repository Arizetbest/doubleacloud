...
function Navbar() {
    ...
    return (
        <div>
            <nav className={color ? "transition-opacity overflow-hidden z-50 delay-150 ease-linear duration-300 bg-black shadow-sm fixed -top-1 w-full py-6 translate-y scroll-smooth px-[6%]" : "z-50 absolute overflow-hidden w-full lg:py-10 md:py-5 sm:py-5 px-[6%]"}>
                <div className={color ? " navLinks  flex justify-between" : "navLinks  justify-between flex"}>
                    <div className="logo flex">
                        <Link to="/" className='text-white flex font-black lg:text-3xl md:text-2xl sm:text-2xl italic'>DoubleACloud</Link>
                    </div>
